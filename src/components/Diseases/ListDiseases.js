        ...
        <View style = { styles.container }>
            ...
            <ScrollView   style={styles.listingBackground}>
                ...
                <TouchableOpacity   style={{ marginLeft: 20, marginTop: 20, flexDirection: 'row'}}
                                    onPress={() => { navigation.navigate('CornDis') }}>
                ...
                <TouchableOpacity   style={{ marginLeft: 20, marginTop: 20, flexDirection: 'row'}}
                                    onPress={() => { navigation.navigate('PotatoDis') }}>
                ...
                <TouchableOpacity   style={{ marginLeft: 20, marginTop: 20, flexDirection: 'row'}}
                                    onPress={() => { navigation.navigate('SoyDis') }}>
                ...
                <TouchableOpacity   style={{ marginLeft: 20, marginTop: 20, flexDirection: 'row'}}
                                    onPress={() => { navigation.navigate('WheatDis') }}>
                ...
                <TouchableOpacity   style={{ marginLeft: 20, marginTop: 20, marginBottom: 20, flexDirection: 'row'}}
                                    onPress={() => { navigation.navigate('CottonDis') }}>
                    <Image  source={require('../../../icons/algodao.png')} 
                            style={{resizeMode: 'contain',
                                    width: 100,
                                    height: 100,
                                    marginBottom: 20}}></Image>
                    <Text style={{fontSize: 26, top: 30, left: 40, marginBottom: 100}}> Algodão </Text>
                </TouchableOpacity>
            </ScrollView>
